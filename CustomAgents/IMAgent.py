...
# Intrinsically motivated agent class that overrides the DQN Class
# This is attaching the agents directly with the environment and the two are no longer decoupled
